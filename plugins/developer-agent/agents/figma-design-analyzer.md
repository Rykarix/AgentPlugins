...
tools: mcp__figma__get_figma_skill, mcp__figma__get_metadata, mcp__figma__get_design_context, mcp__figma__get_screenshot, mcp__figma__get_variable_defs, mcp__figma__get_libraries, mcp__figma__get_code_connect_map, mcp__figma__search_design_system, mcp__figma__download_assets, Read, Glob, Grep
model: haiku
effort: high
---
