...
model: Auto (copilot)
tools: [vscode/askQuestions, execute/getTerminalOutput, execute/killTerminal, execute/sendToTerminal, execute/runTask, execute/createAndRunTask, execute/runTests, execute/testFailure, execute/runInTerminal, read/problems, read/readFile, read/viewImage, read/skill, read/terminalSelection, read/terminalLastCommand, agent, edit/createDirectory, edit/createFile, edit/editFiles, edit/rename, search/fileSearch, search/listDirectory, vscodeTasks/createAndRunTask, vscodeTasks/runTask, vscodeTasks/problems, vscodeGeneral/rename, vscodeGeneral/runTests, vscodeGeneral/testFailure, todo]
user-invocable: true
...
- Delegate the moment any of these is true:
  - You want a second #tool:search/fileSearch or #tool:search/listDirectory call on the same question.
...
- Send independent delegations in a single message with #tool:agent/runSubagent, then keep working or end the turn. Never poll.
...
- Use the provided VS Code tools for discovery, listing, search, read, edit, and tests. Shell is only for work with no tool equivalent.
